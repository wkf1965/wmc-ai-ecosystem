...
export default function DashboardPage() {
  return (
    <div className="min-h-screen p-6">
      <PageHeader
        title="Care CRM"
        description="Pilot-grade enterprise starter for CRM workflows with shared UI primitives and API handlers."
      />
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        ...
        <Card title="Service scope" subtitle="Core boundary">
          <p className="text-sm text-slate-700">CRM domain boundaries and API routes are organized by this module.</p>
        </Card>
